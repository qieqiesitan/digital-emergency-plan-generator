...
export const createMethod = (eid: string, data: { method_type: string; name: string; config: MethodConfig }, config?: AxiosRequestConfig) => api.post<ApiResponse<RiskAssessmentMethod>>(`${BASE(eid)}/methods`, data, config).then(r => r.data.data);
export const updateMethod = (eid: string, mid: string, data: Partial<{ name: string; config: MethodConfig; is_active: boolean }>, config?: AxiosRequestConfig) => api.put<ApiResponse<RiskAssessmentMethod>>(`${BASE(eid)}/methods/${mid}`, data, config).then(r => r.data.data);
export const deleteMethod = (eid: string, mid: string, config?: AxiosRequestConfig) => api.delete(`${BASE(eid)}/methods/${mid}`, config);
export const duplicateMethod = (eid: string, mid: string, config?: AxiosRequestConfig) => api.post<ApiResponse<RiskAssessmentMethod>>(`${BASE(eid)}/methods/${mid}/duplicate`, {}, config).then(r => r.data.data);
...
export const createZone = (eid: string, data: RiskZoneCreate, config?: AxiosRequestConfig) => api.post<ApiResponse<RiskZone>>(`${BASE(eid)}/zones`, data, config).then(r => r.data.data);
export const updateZone = (eid: string, zid: string, data: Partial<RiskZoneCreate>, config?: AxiosRequestConfig) => api.put<ApiResponse<RiskZone>>(`${BASE(eid)}/zones/${zid}`, data, config).then(r => r.data.data);
export const deleteZone = (eid: string, zid: string, config?: AxiosRequestConfig) => api.delete(`${BASE(eid)}/zones/${zid}`, config);
...
export const createObject = (eid: string, data: RiskObjectCreate, config?: AxiosRequestConfig) => api.post<ApiResponse<RiskObject>>(`${BASE(eid)}/objects`, data, config).then(r => r.data.data);
...
export const updateObject = (eid: string, oid: string, data: Partial<RiskObjectCreate>, config?: AxiosRequestConfig) => api.put<ApiResponse<RiskObject>>(`${BASE(eid)}/objects/${oid}`, data, config).then(r => r.data.data);
export const deleteObject = (eid: string, oid: string, config?: AxiosRequestConfig) => api.delete(`${BASE(eid)}/objects/${oid}`, config);

export const listUnits = (eid: string, oid: string) => api.get<ApiResponse<RiskUnit[]>>(`${BASE(eid)}/objects/${oid}/units`).then(r => r.data.data);
export const createUnit = (eid: string, oid: string, data: RiskUnitCreate, config?: AxiosRequestConfig) => api.post<ApiResponse<RiskUnit>>(`${BASE(eid)}/objects/${oid}/units`, data, config).then(r => r.data.data);
export const updateUnit = (eid: string, oid: string, uid: string, data: Partial<RiskUnitCreate>, config?: AxiosRequestConfig) => api.put<ApiResponse<RiskUnit>>(`${BASE(eid)}/objects/${oid}/units/${uid}`, data, config).then(r => r.data.data);
export const deleteUnit = (eid: string, oid: string, uid: string, config?: AxiosRequestConfig) => api.delete(`${BASE(eid)}/objects/${oid}/units/${uid}`, config);

export const createEvent = (eid: string, parentId: string, data: RiskEventCreate, config?: AxiosRequestConfig) => {
  const path = data.object_id && !data.unit_id ? `${BASE(eid)}/objects/${parentId}/events` : `${BASE(eid)}/units/${parentId}/events`;
  return api.post<ApiResponse<RiskEvent>>(path, data, config).then(r => r.data.data);
};
export const updateEvent = (eid: string, evid: string, data: Partial<RiskEventCreate>, config?: AxiosRequestConfig) => api.put<ApiResponse<RiskEvent>>(`${BASE(eid)}/events/${evid}`, data, config).then(r => r.data.data);
export const deleteEvent = (eid: string, evid: string, config?: AxiosRequestConfig) => api.delete(`${BASE(eid)}/events/${evid}`, config);
...
export const createMeasure = (eid: string, evid: string, data: RiskMeasureCreate, config?: AxiosRequestConfig) => api.post<ApiResponse<RiskMeasure>>(`${BASE(eid)}/events/${evid}/measures`, data, config).then(r => r.data.data);
export const updateMeasure = (eid: string, evid: string, mid: string, data: Partial<RiskMeasureCreate & { status: string }>, config?: AxiosRequestConfig) => api.put<ApiResponse<RiskMeasure>>(`${BASE(eid)}/events/${evid}/measures/${mid}`, data, config).then(r => r.data.data);
export const deleteMeasure = (eid: string, evid: string, mid: string, config?: AxiosRequestConfig) => api.delete(`${BASE(eid)}/events/${evid}/measures/${mid}`, config);
...
export const resetRiskPublicityToken = (enterpriseId: string, config?: AxiosRequestConfig) => {
  const call = config
    ...
    : api.post<ApiResponse<{ token: string }>>(`${BASE(enterpriseId)}/risk-publicity/token`);
