...
CHAT_TOOLS = [
    {"type": "function", "function": {"name": "get_dashboard", "description": "获取仪表盘统计概览：企业数、预案数(含已完成/生成中)、风险源数、应急资源数", "parameters": {"type": "object", "properties": {}, "required": []}}},
    ...
    {"type": "function", "function": {"name": "get_enterprise", "description": "获取企业详情：基本信息+风险源列表+应急资源列表+预案列表", "parameters": {"type": "object", "properties": {"enterprise_id": {"type": "string"}, "name": {"type": "string", "description": "企业名称模糊匹配"}}, "required": []}}},
    ...
    {"type": "function", "function": {"name": "list_risk_sources", "description": "列出指定企业的所有风险源", "parameters": {"type": "object", "properties": {"enterprise_id": {"type": "string", "description": "企业ID(必填)"}}, "required": ["enterprise_id"]}}},
    {"type": "function", "function": {"name": "create_risk_source", "description": "为企业创建风险源", "parameters": {"type": "object", "properties": {"enterprise_id": {"type": "string", "description": "企业ID(必填)"}, "name": {"type": "string", "description": "风险源名称(必填)"}, "categories": {"type": "string"}, "location": {"type": "string"}, "risk_level": {"type": "string", "description": "低/中/较高/高"}, "control_measures": {"type": "string"}}, "required": ["enterprise_id", "name"]}}},
    {"type": "function", "function": {"name": "update_risk_source", "description": "更新风险源信息", "parameters": {"type": "object", "properties": {"risk_source_id": {"type": "string", "description": "风险源ID(必填)"}, "name": {"type": "string"}, "categories": {"type": "string"}, "location": {"type": "string"}, "risk_level": {"type": "string"}, "control_measures": {"type": "string"}}, "required": ["risk_source_id"]}}},
    {"type": "function", "function": {"name": "delete_risk_source", "description": "删除风险源", "parameters": {"type": "object", "properties": {"risk_source_id": {"type": "string", "description": "风险源ID(必填)"}}, "required": ["risk_source_id"]}}},
